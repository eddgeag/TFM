...
colnames(datos.gg)<-c("sample","factor","value","group","group_by","grupo","obesos")
datos.gg$interaccion<-interaccion
ggstatsplot::grouped_ggbetweenstats(datos.gg,y=value,x=interaccion,grouping.var = "factor",type="np")
ggstatsplot::ggbetweenstats(datos.gg[datos.gg$factor=="Factor3",],y=value,x=interaccion,type="np")
```
