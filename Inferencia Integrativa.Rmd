...
cont.matrix <- makeContrasts(females = NoObese.Female-Obese.Female,
...
fit <- lmFit(assay(sse.metaboloma),design = design,method = "robust")
fit2 <- contrasts.fit(fit,cont.matrix)
fit3 <- eBayes(fit2)
toptablemio <- topTable(fit3,coef=1:6,number = 37,adjust.method = "BH",confint = T)
